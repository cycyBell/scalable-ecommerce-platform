...
/**
 * ==============================================================================
 * SERVICE: OrderService (Distributed Transaction & SAGA Coordinator)
 * ==============================================================================
...
public class OrderService {
    ...
    private <T> T deserializePayload(String json, Class<T> clazz) {
        try {
            ...
            throw new IllegalStateException("Failed to deserialize JSON payload", e);
        }
    }

    private record ReservedItemTracker(String productId, int quantity) {}
}
