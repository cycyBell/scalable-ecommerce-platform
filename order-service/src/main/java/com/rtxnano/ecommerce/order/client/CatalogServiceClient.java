...
public class CatalogServiceClient {
    ...
    public CatalogServiceClient(@Qualifier("catalogRestClient") RestClient catalogRestClient) {
     ...
     * Negative quantityChange decreases stock; positive quantityChange increases stock.
     */
